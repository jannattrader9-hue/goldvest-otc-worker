...
// ═══════════════════════════════════════════════════════════════════════════
// GoldVest Candle Engine v3 — Professional Force-Based OTC Simulator
// ═══════════════════════════════════════════════════════════════════════════
//
...
//
// otc-server.js থেকে:  generateTickV3(state, ctrl, stats)
// নতুন market এ:        initStateV3(price)  → spread into state
// ═══════════════════════════════════════════════════════════════════════════
...
// ─────────────────────────────────────────────────────────────────────────
function generateTickV3(state, ctrl, stats) {
  ...
  const netForce = trendForce + noiseForce + liqForce + reversionForce + hesitationForce + closePush;
  ...
  // velocity += acceleration, তারপর friction
  state._velocity += state._acceleration;
  state._velocity *= 0.86; // friction/inertia — smooth glide
...
module.exports = { generateTickV3, initStateV3 };
